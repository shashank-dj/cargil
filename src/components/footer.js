        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div class="md:col-span-1">
            ...
            <div class="flex gap-4">
              ...
              <!-- LinkedIn -->
              <a href="https://www.linkedin.com/in/shashank-tk" target="_blank" rel="noopener noreferrer"
                 class="w-8 h-8 border border-forest-600 flex items-center justify-center text-gray-500 hover:border-lime-400 hover:text-lime-400 transition-colors">
              ...
              <!-- GitHub -->
              <a href="https://github.com/shashank-dj/cargil" target="_blank" rel="noopener noreferrer"
                 class="w-8 h-8 border border-forest-600 flex items-center justify-center text-gray-500 hover:border-lime-400 hover:text-lime-400 transition-colors">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
